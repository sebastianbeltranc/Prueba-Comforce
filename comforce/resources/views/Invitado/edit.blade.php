...
<div class="formulario">
  ...
  <!-- INICIO FORMULARIO PARA EDITAR PROCESO -->
  {!! Form::model($proceso, ['route' => ['procesos.update', $proceso]]) !!}
    ...
    <div class="container">
        ...
        <div class="btns">
          ...
          <div class="save">
            {!! Form::submit('Guardar', array('style'=>'cursor:pointer')) !!}
          </div>
        </div>
    </div>
  {!! Form::close() !!}
  <!-- FIN FORMULARIO PARA EDITAR PROCESO -->
</div>
@endsection
